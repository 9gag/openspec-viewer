...
// Remembered per browser: which mode you read in is a property of you and your screen,
// not of the store.
...
export function loadMode() {
  // ?mode=dark so a link can carry the view it was written for. Not persisted — the
  // override lasts the visit.
